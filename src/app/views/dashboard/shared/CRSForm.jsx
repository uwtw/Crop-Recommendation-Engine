...
const CRSForm = (props) => {
  ...
  const handleCropTimeToggleChange = () => {
      ...
      <Grid item xs={6}>
        <ContentBox>
          ...
          <FormGroup>
            <FormControlLabel
              control={
                <MaterialUISwitch sx={{ m: 1 }} onChange={handleModeChange} />
              }
            />
          </FormGroup>
  ...
  const cropTimeToggle = (
    <Grid item xs={6}>
      <ContentBox>
        ...
        <FormGroup>
          <FormControlLabel
            control={<MaterialUISwitch onChange={handleCropTimeToggleChange} />}
          />
        </FormGroup>
